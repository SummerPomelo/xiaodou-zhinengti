...
export async function fetchMessagesSummary({
  ...
  // Skip topic naming if no model configured (custom build: no default model)
 ...
 */
export async function checkApi(provider: Provider, model: Model, timeout = 30000): Promise<void> {
