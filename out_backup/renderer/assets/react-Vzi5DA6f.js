...
import { n as CustomVideoElement, t as MediaTracksMixin } from "./dist-BAf30B6O.js";
...
var DashVideoElement = class extends MediaTracksMixin(CustomVideoElement) {
	...
	async load() {
		...
		this.#apiInit = true;
		const Dash = await __vitePreload(() => import("./dash.all.min-Ciy9Q6gg.js"), [], import.meta.url);
